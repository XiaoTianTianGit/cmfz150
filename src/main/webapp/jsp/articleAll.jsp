            ...
            colModel:[
                ...
                {name:"",editable:true,
                        formatter:function (cellValue, opo, value) {
                            return"<a href='#' onclick=\"lookInfor('"+value.id+"')\"><b>查看详情</b></a>" +
                                " <a href='#' onclick=\"updataInfor('"+value.id+"')\"> <b>更新文章</b></a>";
                ...
                <form action="" class="form-horizontal"
                   ...
                   <div class="form-group">
                       <%-- <label class="col-sm-1 control-label">id</label>--%>
                        <div class="col-sm-5">
                            <input type="hidden" name="id" id="id2" placeholder="文章id" class="form-control" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">标题</label>
